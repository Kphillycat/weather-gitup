Simple Weather App in AngularJS utilizating [Loopback Framework](http://loopback.io/) to connect to a [SOAP Weather API](http://wsf.cdyne.com/WeatherWS/Weather.asmx?WSDL).
Use
